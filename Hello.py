...
(e.g. not to leave externals on a hot day on the dashboard of an automobile)''',
            ...
            +" Since 35 degrees in saudi arabia is less than +40°C and greater than +5°C the temperature is falling within the thresold i.e.., +5°C to +40°C  for sound processors.<Conclusion> Yes, Its safe to travel".         
...
When wearing a mask avoid pressure over the implant site''',
            ...
            +"you are willing to do diving to 60 meters for sound processors,since 60 meters >40 meters where 40 meters is the maximum withstandable pressure for This device as per the souce information hence it is not recommended. <Conclusion> Yes, it may harm the device".'''
